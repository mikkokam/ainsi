...
- [Frontmatter](guide/frontmatter.md) — the seven keys, including logos.
- [Themes](guide/themes.md) — the anatomy of a theme folder, the token contract, and how to keep one beside your deck.
- [The CLI](guide/cli.md) — every command and flag.
- [Claude Code](guide/claude-code.md) — adding the plugin, and what having the skill changes.
- [The studio](guide/studio.md) — the browser editor: gestures, menus, keys, exports.
