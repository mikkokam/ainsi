...
.pac-page article > :is(p, ul, ol, blockquote, pre, .pac-prose) + :is(p, ul, ol, blockquote, pre, .pac-prose) { margin-top: calc(var(--pac-em) * .55); }
.pac-page article > :is(h1, h2, h3, h4, h5) + :is(p, ul, ol, blockquote, pre, .pac-prose) { margin-top: calc(var(--pac-em) * .35); }
.pac-page article > :is(p, ul, ol, blockquote, pre, .pac-prose) + :is(h2, h3, h4, h5) { margin-top: calc(var(--pac-em) * 1); }
