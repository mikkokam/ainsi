/**
 * The stand-in for an image not yet chosen: an empty url renders this, and a layout's
 * no-image ground paints it via --ainsi-placeholder. Placeholder_view_vector.svg from
